...
public class ReportingEndpoints : IEndpointMapper
{
    public void MapEndpoints(WebApplication app)
    {
        ...
        app.MapGet("/api/reports/time-entries", async (
        ...
        app.MapGet("/api/reports/summary/by-project", async (
            ApplicationDbContext db,
            DateTime? startDate,
            DateTime? endDate) =>
        {
        ...
        app.MapGet("/api/reports/summary/by-client", async (
            ApplicationDbContext db,
            DateTime? startDate,
            DateTime? endDate) =>
        {
        ...
        // Get summary by user
        app.MapGet("/api/reports/summary/by-user", async (
            ApplicationDbContext db,
            DateTime? startDate,
            DateTime? endDate) =>
        {
